...
node scripts/verify.js --pwa                           # → 2499 + 125 checks
```
...
Across 75 suites, 2499 checks, plus 125 more on the split build. Those numbers are
