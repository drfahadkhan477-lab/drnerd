...
```bash
node scripts/build.js --keep              # once, keeps all 86 intermediates
# ...edit scripts/theme-patch.js...
node scripts/build.js --keep --from theme # only steps 14-86 rerun
```
...
tests/        75 suites · 35 need no browser · + pwa
