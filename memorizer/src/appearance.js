...
var THEMES = [
  ...
  /* Five more, from colour pairs the owner brought (a reel of "colour combos
     for an AI app"), each pair kept as shown and the rest of the palette
     drawn to fit it: Ice (Quantum Blue on Ice Glass) and Butter (Royal
     Iris on Butter Yellow) in the light; Mint Night (Ghost Green on Zero
     Black), Graphite (a blue accent, the reel's lime swapped out so the
     accent is never the green that means "right"), and Grape (Acid Lime
     on Cyber Grape — the owner's choice, lime and all) in the dark. */
  { id: 'ice', name: 'Ice', mode: 'light', swatch: ['#EEF9FF', '#2457FF'], source: null,
    t: { bg: '#EEF9FF', surface: '#FFFFFF', 'surface-2': '#E3F4FC', ink: '#0B1B3A', muted: '#46587A', line: '#CFE6F1',
         accent: '#2457FF', 'accent-soft': '#DFF7FF', 'accent-ink': '#FFFFFF' },
    hero: { 'hero-a': '#DFF7FF', 'hero-b': '#EAFAFF', 'hero-c': '#FFFFFF', 'hero-accent': '#2457FF', 'hero-edge': 'rgba(36,87,255,.14)',
            'hero-ink': '#0B1B3A', 'hero-muted': '#46587A', 'hero-pill': 'rgba(0,0,0,.04)', 'hero-pill-edge': 'rgba(0,0,0,.08)' },
  ...
  { id: 'mint', name: 'Mint Night', mode: 'dark', swatch: ['#050505', '#8CF0AE'], source: null,
    ...
    brain: { t1: 'rgba(215,255,224,.18)', t2: 'rgba(120,180,140,.12)', t3: 'rgba(10,20,14,.5)', sulcus: 'rgba(215,255,224,.16)', rim: 'rgba(215,255,224,.35)',
             sheen: 'rgba(255,255,255,.06)', axon: 'rgba(215,255,224,.14)', dendrite: 'rgba(215,255,224,.38)', dormant: '#1A221D', spark: '#F4FFF6', glint: 'rgba(215,255,224,.22)',
             stage: 'radial-gradient(80% 90% at 35% 30%, rgba(215,255,224,.07), transparent 70%)' } },
  { id: 'butter', name: 'Butter', mode: 'light', swatch: ['#FFFBE3', '#3A0CA3'], source: null,
    t: { bg: '#FFFBE3', surface: '#FFFFFF', 'surface-2': '#FFF6C2', ink: '#1A0E3D', muted: '#564A78', line: '#EFE5A6',
         accent: '#3A0CA3', 'accent-soft': '#EEE8FF', 'accent-ink': '#FFFFFF' },
    hero: { 'hero-a': '#FFF275', 'hero-b': '#FFF59A', 'hero-c': '#FFF9C9', 'hero-accent': '#3A0CA3', 'hero-edge': 'rgba(58,12,163,.14)',
            'hero-ink': '#1A0E3D', 'hero-muted': '#4A3E6E', 'hero-pill': 'rgba(0,0,0,.05)', 'hero-pill-edge': 'rgba(0,0,0,.09)' },
    brain: { t1: '#F3EAFF', t2: '#E6D9FA', t3: '#CDBCEB', sulcus: 'rgba(58,12,163,.24)', rim: 'rgba(255,255,255,.95)', sheen: 'rgba(255,255,255,.6)',
             axon: 'rgba(58,12,163,.18)', dendrite: 'rgba(58,12,163,.45)', dormant: '#FBF7FF', spark: '#3A0CA3', glint: 'rgba(255,250,200,.85)',
             stage: 'radial-gradient(90% 90% at 30% 20%, rgba(255,242,117,.28), transparent 70%)' } },
  { id: 'graphite', name: 'Graphite', mode: 'dark', swatch: ['#15181C', '#6E9BFF'], source: null,
    t: { bg: '#15181C', surface: '#1F2329', 'surface-2': '#2A2F37', ink: '#F2F5F7', muted: '#A9B1BB', line: '#333A43',
         accent: '#6E9BFF', 'accent-soft': '#1A2440', 'accent-ink': '#0B1020' },
    hero: { 'hero-a': '#1F2329', 'hero-b': '#262B32', 'hero-c': '#181B20', 'hero-accent': '#6E9BFF', 'hero-edge': 'rgba(110,155,255,.18)',
            'hero-ink': '#F2F5F7', 'hero-muted': '#A9B1BB', 'hero-pill': 'rgba(255,255,255,.06)', 'hero-pill-edge': 'rgba(255,255,255,.11)' },
    brain: { t1: 'rgba(110,155,255,.22)', t2: 'rgba(90,110,150,.14)', t3: 'rgba(10,12,16,.45)', sulcus: 'rgba(180,200,240,.18)', rim: 'rgba(140,170,255,.35)',
             sheen: 'rgba(255,255,255,.06)', axon: 'rgba(170,190,230,.16)', dendrite: 'rgba(170,190,230,.40)', dormant: '#262B33', spark: '#DDE8FF', glint: 'rgba(190,210,255,.24)',
             stage: 'radial-gradient(80% 90% at 35% 30%, rgba(110,155,255,.10), transparent 70%)' } },
  { id: 'grape', name: 'Grape', mode: 'dark', swatch: ['#120A24', '#D7FF00'], source: null,
    t: { bg: '#120A24', surface: '#1C1236', 'surface-2': '#281A4A', ink: '#F4F0FF', muted: '#B7A8DD', line: '#34235F',
         accent: '#D7FF00', 'accent-soft': '#262040', 'accent-ink': '#120A24' },
    hero: { 'hero-a': '#4C1D95', 'hero-b': '#3B1580', 'hero-c': '#2E1065', 'hero-accent': '#D7FF00', 'hero-edge': 'rgba(215,255,0,.22)',
            'hero-ink': '#F7F3FF', 'hero-muted': '#D9CCFF', 'hero-pill': 'rgba(255,255,255,.08)', 'hero-pill-edge': 'rgba(255,255,255,.14)' },
    brain: { t1: 'rgba(160,110,255,.34)', t2: 'rgba(109,40,217,.18)', t3: 'rgba(30,10,70,.45)', sulcus: 'rgba(210,190,255,.22)', rim: 'rgba(190,160,255,.42)',
             sheen: 'rgba(220,200,255,.12)', axon: 'rgba(190,170,255,.18)', dendrite: 'rgba(200,180,255,.42)', dormant: '#2A1B52', spark: '#EFFF9E', glint: 'rgba(215,255,0,.18)',
             stage: 'radial-gradient(80% 90% at 35% 30%, rgba(109,40,217,.28), transparent 70%)' } },
...
var GLOW = {
  ...
  ice: { a2: '#1A3FCC', aura: ['rgba(36,87,255,.12)', 'rgba(120,210,255,.14)', 'rgba(36,87,255,.08)'] },
  mint: { a2: '#A8F0BC', aura: ['rgba(215,255,224,.08)', 'rgba(120,200,160,.08)', 'rgba(215,255,224,.05)'] },
  butter: { a2: '#2A0880', aura: ['rgba(255,226,60,.16)', 'rgba(58,12,163,.08)', 'rgba(255,242,117,.14)'] },
  graphite: { a2: '#4F83FF', aura: ['rgba(110,155,255,.12)', 'rgba(80,120,220,.08)', 'rgba(255,255,255,.04)'] },
  grape: { a2: '#B8E000', aura: ['rgba(109,40,217,.16)', 'rgba(215,255,0,.06)', 'rgba(160,110,255,.12)'] },
};
