...
const WIRING = [
  ...
  '  const z={st:FigZoom.fit(), pts:new Map(), moved:false, pinchAt:0};',
  '  const box=()=>scroll.getBoundingClientRect();',
  '  /* Fitted layout size; read live so rotation stays honest. */',
  ...
  '      if(Math.abs(dx)>0||Math.abs(dy)>0) z.moved=true;',
  '      ev.preventDefault();',
