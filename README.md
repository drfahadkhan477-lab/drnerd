...
node scripts/verify.js                              # 1706 checks, 51 suites
node scripts/verify.js --pwa                        # + 93 more on the split build
...
**That badge is not the 1706 + 93 checks above — read it as 299, not 1799.**
