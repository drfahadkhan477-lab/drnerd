...
node scripts/verify.js                              # 1013 checks, 31 suites
...
**That badge is not the 1013 + 75 checks above — read it as 89, not 1088.**
...
scope and why the other 924 checks can't run here.
