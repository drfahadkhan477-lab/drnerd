...
node scripts/verify.js                              # 1085 checks, 33 suites
...
**That badge is not the 1085 + 76 checks above — read it as 89, not 1161.**
...
scope and why the other 996 checks can't run here.
