...
node scripts/verify.js                              # 1017 checks, 31 suites
...
**That badge is not the 1017 + 75 checks above — read it as 89, not 1092.**
...
scope and why the other 928 checks can't run here.
