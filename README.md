...
node scripts/verify.js                              # 1031 checks, 31 suites
...
**That badge is not the 1031 + 75 checks above — read it as 89, not 1106.**
...
scope and why the other 942 checks can't run here.
