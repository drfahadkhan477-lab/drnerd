...
node scripts/verify.js                              # 1066 checks, 32 suites
...
**That badge is not the 1066 + 76 checks above — read it as 89, not 1142.**
...
scope and why the other 977 checks can't run here.
