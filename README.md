...
node scripts/verify.js                              # 2331 checks, 71 suites
...
**That badge is not the 2331 + 125 checks above — read it as 847, not 2456.**
...
present, and the 26 suites that need neither a browser nor a build all stay
