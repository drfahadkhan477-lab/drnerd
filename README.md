...
node scripts/verify.js                              # 2499 checks, 75 suites
...
**That badge is not the 2499 + 125 checks above — read it as 1015, not 2624.**
...
present, and the 33 suites that need neither a browser nor a build all stay
