...
node scripts/verify.js                              # 1723 checks, 54 suites
node scripts/verify.js --pwa                        # + 106 more on the split build
...
**That badge is not the 1723 + 106 checks above — read it as 304, not 1829.**
